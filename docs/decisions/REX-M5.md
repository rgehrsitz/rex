...
Status: implemented locally; review pending, 2026-09-08. Depends on M4, merged in PR #35
...
v4 scripts are unavailable regardless. Routing checks cover results-channel
