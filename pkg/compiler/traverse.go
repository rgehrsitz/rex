...
// getNextLabel generates a new label with the given prefix and returns it.
// The label is generated by appending a three-digit number to the prefix.
// The labelCounter variable keeps track of the current label number.
