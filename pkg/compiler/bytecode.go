...
func (op Opcode) HasOperands() bool {
	switch op {
	case ACTION_START, OP_LITERAL, RULE_START, LOAD_CONST_FLOAT, LOAD_CONST_STRING, LOAD_CONST_BOOL, LOAD_FACT, JUMP, JUMP_IF_TRUE, JUMP_IF_FALSE, LABEL:
		return true
	default:
		return false
	}
...
func (op Opcode) String() string {
	names := [...]string{
		...
		"CHECKSUM", "VERSION", "NUM_RULES", "CONST_POOL_SIZE",
		"OP_LITERAL",
	}
